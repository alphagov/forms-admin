  ...
  describe "submission type" do
    describe "enum" do
      it "returns a list of submission types" do
        expect(described_class.submission_types.keys).to eq(%w[email email_with_csv email_with_json email_with_csv_and_json s3])
        expect(described_class.submission_types.values).to eq(%w[email email_with_csv email_with_json email_with_csv_and_json s3])
      end
    end
  end
