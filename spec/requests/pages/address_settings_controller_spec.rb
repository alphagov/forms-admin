  ...
  describe "#create" do
    ...
    context "when form is valid and ready to store" do
      ...
      it "saves the input type to DB" do
        ...
        expect(form_instance_variable.draft_question.answer_settings).to include({ input_type: { uk_address: address_settings_form.uk_address, international_address: address_settings_form.international_address } })
      end
