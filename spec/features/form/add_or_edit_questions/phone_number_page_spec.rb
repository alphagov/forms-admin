...
feature "Add/editing a phone number question", type: :feature do
  ...
  context "when a form has no existing pages" do
    ...
    scenario "add a phone number question" do
      when_i_viewing_an_existing_form
      and_i_want_to_create_or_edit_a_page
      and_i_select_a_phone_number_option
...
private
  ...
  def and_i_select_a_phone_number_option
