...
feature "Add/editing a multiple line question", type: :feature do
  ...
  context "when a form has no existing pages" do
    ...
    scenario "add a multiple line question" do
      when_i_viewing_an_existing_form
      and_i_want_to_create_or_edit_a_page
      and_i_select_a_multiple_line_option
