...
describe PageRepository do
  ...
  describe "#find" do
    ...
    describe "database" do
      ...
      context "when the page is already in the database" do
        let!(:existing_page) { create(:page, id: page.id, form_id:) }
  ...
  describe "#save!" do
    let(:page) { create(:page, form:, is_optional: false) }
    ...
    describe "database" do
      ...
      context "when there are no changes to save" do
        let(:form) { create(:form, question_section_completed: true) }
        let(:page) { create(:page, form: form, answer_type: "number", answer_settings: { foo: "bar" }) }
  ...
  describe "#destroy" do
    ...
    describe "database" do
      ...
      context "when the page has routing conditions" do
        before do
          create(:condition, routing_page_id: page.id, check_page_id: page.id, goto_page_id: nil, skip_to_end: true, answer_value: "Red")
          create(:condition, routing_page_id: page.id, check_page_id: page.id, goto_page_id: nil, skip_to_end: true, answer_value: "Green")
          page.reload
        end
