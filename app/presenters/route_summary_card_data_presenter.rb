...
private
      ...
      rows: [
        {
          ...
          html_attributes: { id: "check-#{routing_condition.id}" },
          classes: "govuk-form-group govuk-form-group--error",
        ...
        },
        {
          ...
          html_attributes: { id: "goto-#{routing_condition.id}" },
          classes: "govuk-form-group govuk-form-group--error",
  ...
  def secondary_skip_rows
    ...
    [
      ...
      },
      {
        ...
        html_attributes: { id: "goto-#{secondary_skip.id}" },
        value: { text: safe_join([goto_page_next_error, goto_page_before_error, goto_page_name]) },
      },
    ]
  end
  ...
  def format_error(message)
    "<div class=\"govuk-error-summary__body\"><p class=\"govuk-error-message\">#{message}</p></div> ".html_safe
  end
end
