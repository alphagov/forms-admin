class Form < ApplicationRecord
  ...
  ATTRIBUTES_NOT_IN_FORM_DOCUMENT = %i[state external_id pages question_section_completed declaration_section_completed share_preview_completed welse_completed].freeze
...
private
  ...
  def task_status_service
    # we shouldn't be doing this https://stackoverflow.com/a/67425448
