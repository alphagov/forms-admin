module Forms
  ...
  private
    ...
    def success_message(previous_payment_url, new_payment_url)
      return nil if previous_payment_url == new_payment_url
      return t("banner.success.form.payment_link_removed") if new_payment_url.blank?

      t("banner.success.form.payment_link_saved")
    end
  end
end
