module Forms
  class MakeLanguageLiveController < FormsController
    def new
      ...
      @make_language_live_input = MakeLanguageLiveInput.new(form: current_form)
    ...
    def create
      ...
      @make_language_live_input = MakeLanguageLiveInput.new(**make_language_live_input_params)
  ...
  private
    ...
    def make_language_live_input_params
      params.require(:forms_make_language_live_input).permit(:confirm, :language).merge(form: current_form)
    end
