module Forms
  class WelshTranslationController < WebController
    ...
    def welsh_translation_input_params
      params.require(:forms_welsh_translation_input).permit(WelshTranslationInput.attribute_names, pages: %i[id question_text_cy hint_text_cy page_heading_cy guidance_markdown_cy]).merge(form: current_form)
    end
