class Pages::LongListsSelection::OptionsController < PagesController
  def new
    @selection_options_input = Pages::LongListsSelection::OptionsInput.new(selection_options: draft_question.answer_settings[:selection_options]
                                                                           ...
                                                                           draft_question:)
    @selection_options_path = long_lists_selection_options_create_path(current_form.id)
    @back_link_url = long_lists_selection_type_new_path(current_form.id)
    @bulk_options_url = long_lists_selection_bulk_options_new_path(current_form.id)
  ...
  def edit
    @selection_options_input = Pages::LongListsSelection::OptionsInput.new(selection_options: draft_question.answer_settings[:selection_options]
                                                                           ...
                                                                           include_none_of_the_above: draft_question.is_optional,
                                                                           draft_question:)
    @selection_options_path = long_lists_selection_options_update_path(current_form.id)
    @back_link_url = edit_question_path(current_form.id)
    @bulk_options_url = long_lists_selection_bulk_options_edit_path(current_form.id)
    render "pages/long_lists_selection/options", locals: { current_form: }
  end
