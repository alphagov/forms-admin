...
private
  ...
  def selection_options_param_values
    selections_settings_input_params[:selection_options] ? selections_settings_input_params[:selection_options].values : []
  end

  def only_one_option_param_values
    selections_settings_input_params[:only_one_option]
  end
