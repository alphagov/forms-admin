  ...
  scope "forms/:form_id" do
    ...
    scope "/pages" do
      ...
      scope "/new" do
        ...
        get "/selection/bulk-options" => "pages/long_lists_selection/bulk_options#new", as: :long_lists_selection_bulk_options_new
        post "/selection/bulk-options" => "pages/long_lists_selection/bulk_options#create", as: :long_lists_selection_bulk_options_create
      ...
      scope "/:page_id" do
        ...
        scope "/edit" do
          ...
          get "/selection/bulk-options" => "pages/long_lists_selection/bulk_options#edit", as: :long_lists_selection_bulk_options_edit
          post "/selection/bulk-options" => "pages/long_lists_selection/bulk_options#update", as: :long_lists_selection_bulk_options_update
